...
template
<
   class T0 = none , class T1 = none , class T2 = none
>
struct tiny
{
   typedef tiny type;
...
struct tiny_at;
        template<class Tiny> struct tiny_at<Tiny, 0> { typedef typename Tiny::t0 type; };
        template<class Tiny> struct tiny_at<Tiny, 1> { typedef typename Tiny::t1 type; };
        template<class Tiny> struct tiny_at<Tiny, 2> { typedef typename Tiny::t2 type; };
...
struct tiny_pop_back;
        template<class Tiny> struct tiny_pop_back<Tiny, 1> : tiny<> {};
        template<class Tiny> struct tiny_pop_back<Tiny, 2> : tiny<typename Tiny::t0 > {};
        template<class Tiny> struct tiny_pop_back<Tiny, 3> : tiny<typename Tiny::t0 , typename Tiny::t1 > {};
template<class Tiny, class T, int N>
struct tiny_push_front;
        template<class Tiny, class T> struct tiny_push_front<Tiny, T, 0> : tiny<T, none , none> {};
        template<class Tiny, class T> struct tiny_push_front<Tiny, T, 1> : tiny<T, typename Tiny::t0 , none> {};
        template<class Tiny, class T> struct tiny_push_front<Tiny, T, 2> : tiny<T, typename Tiny::t0 , typename Tiny::t1 > {};
template<class Tiny, class T, class Pos, bool Is_full>
struct tiny_insert;
> {};
        template<class Tiny, class T> struct tiny_insert<Tiny, T, tiny_iterator<Tiny, boost::mpl::int_<0>>, false> : tiny< T , typename Tiny::t , typename Tiny::t \
        template<class Tiny, class T> struct tiny_insert<Tiny, T, tiny_iterator<Tiny, boost::mpl::int_<1>>, false> : tiny< typename Tiny::t0 , T , typename Tiny::t \
        template<class Tiny, class T> struct tiny_insert<Tiny, T, tiny_iterator<Tiny, boost::mpl::int_<2>>, false> : tiny< typename Tiny::t0 , typename Tiny::t1 , T \
namespace boost
{
   namespace mpl
   {
